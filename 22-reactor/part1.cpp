...
struct boxset
{
    ...
    void add(const box& b, std::list<box>::iterator it);
...
void boxset::add(const box& b, std::list<box>::iterator it)
{
    while (it != l.end())
    {
        const box& B = *it;
        if (b.intersects(B))
        {
            if (b.x1 < B.x1)
            {
                add(box(b.x1, b.y1, b.z1, B.x1 - 1, b.y2, b.z2), it);
                add(box(B.x1, b.y1, b.z1, b.x2, b.y2, b.z2), it);
            }
            else if (B.x2 < b.x2)
            {
                add(box(b.x1, b.y1, b.z1, B.x2, b.y2, b.z2), it);
                add(box(B.x2 + 1, b.y1, b.z1, b.x2, b.y2, b.z2), it);
            }
            else if (b.y1 < B.y1)
            {
                add(box(b.x1, b.y1, b.z1, b.x2, B.y1 - 1, b.z2), it);
                add(box(b.x1, B.y1, b.z1, b.x2, b.y2, b.z2), it);
            }
            else if (B.y2 < b.y2)
            {
                add(box(b.x1, b.y1, b.z1, b.x2, B.y2, b.z2), it);
                add(box(b.x1, B.y2 + 1, b.z1, b.x2, b.y2, b.z2), it);
            }
            else if (b.z1 < B.z1)
            {
                add(box(b.x1, b.y1, b.z1, b.x2, b.y2, B.z1 - 1), it);
                add(box(b.x1, b.y1, B.z1, b.x2, b.y2, b.z2), it);
            }
            else if (B.z2 < b.z2)
            {
                add(box(b.x1, b.y1, b.z1, b.x2, b.y2, B.z2), it);
                add(box(b.x1, b.y1, B.z2 + 1, b.x2, b.y2, b.z2), it);
            }
            return;
        }
        ++it;
